     ...
     <div class="row">
        ...
        <div class="col-xs-12 col-sm-12 col-md-12">
            <div class="form-group">
                ...
                <input type="text" name="ESRB" class="form-control" placeholder="Enter ESRB Rating">
            </div>
        </div>
        <div class="col-xs-12 col-sm-12 col-md-12">
            <div class="form-group">
                <strong>Estimated Play Time (Hours):</strong>
                <input type="number" step='0.1' name="EstimatedPlayTime" class="form-control" placeholder="Enter Estimated Play Time in Hours">
            </div>
        </div>
